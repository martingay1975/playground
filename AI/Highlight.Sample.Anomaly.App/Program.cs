...
namespace Highlight.Sample.Anomaly.App
{
    internal class Program
    {
        ...
        private const string changepointData = "Oct24-Avg-19768-19871.csv";

        private const string dataFile = changepointData;
        ...
        private static void RunByChangePointSsa()
        {
            ...
            var loadInData = LoadData(dataFile);
            ...
            PrintSpikeDetection(outputDto, GetSpikesByAlert(outputDto));
        ...
        private static void RunBySpikeIId()
        {
            ...
            PrintSpikeDetection(outputDto, GetSpikesByAlert(outputDto));
            PrintSpikeDetection(outputDto, GetSpikesByBelow0_02(outputDto));
        ...
        private static void PrintSpikeDetection(IEnumerable<OutputDto> outputList, IEnumerable<OutputDto> spikes)
        {
            Console.WriteLine("");
